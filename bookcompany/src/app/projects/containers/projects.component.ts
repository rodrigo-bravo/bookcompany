...
export class ProjectsComponent implements OnInit {
  ...
  constructor(private store: Store<AppState>, private modalService: MDBModalService, private afAuth: AngularFireAuth, private titleService: Title) { }
  ...
  addBook() {
    ...
    this.modalRef.content.heading = 'Upload Item to Collection';
